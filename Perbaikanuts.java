...
public class Perbaikanuts {
    public static void main(String[] args) {
        ...
        input.add(new Mahasiswa("sam", "Algoritma", 4, 88));
        input.add(new Mahasiswa("Haidar", "Kalkulus", 2, 75));
        input.add(new Mahasiswa("Udin", "Kalkulus", 2, 84));
        input.add(new Mahasiswa("Emu", "Logika", 1, 92));
        input.add(new Mahasiswa("Ogoh", "Statistika", 3, 96));
        ...
        do{
            ...
            switch (pilihan){
                case 1:
                  System.out.println("Masukan Nama, Mata Kuliah, SKS, Nilai : ");
